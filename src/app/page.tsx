...
export default function Home() {
  ...
  const images = [
    ...
    { url: "https://res.cloudinary.com/dnxxkvpiz/image/upload/v1745638046/adoptadog/sliders/banner1_ufl3dt.jpg" },
  ...
  const imagesMobile = [
    ...
    { url: "https://res.cloudinary.com/dnxxkvpiz/image/upload/v1745638046/adoptadog/sliders/mobile2_tuvqcd.jpg" },
