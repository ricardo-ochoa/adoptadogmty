...
const Links = () => {
    ...
    const links = [
        {
            href: "https://api.whatsapp.com/send?phone=8117711668&text=Hola%20quiero%20contactar%20con%20AdoptADog%20MTY",
    ...
    return (
        <>
            <ImageBanner
                imageUrl={imageBanner.url} 
                altText={imageBanner.altText}
                className=""
            />
            <div className="min-h-screen flex flex-col items-center justify-center">
                <div className="text-center mb-10">
                    ...
                    />
                    <h1 className="text-xl font-bold text-purple-700 mb-2 animate__animated animate__fadeInDown">@AdoptADogMTY</h1>
                ...
                <div className="flex gap-8 mb-8 animate__animated animate__fadeInDown">
